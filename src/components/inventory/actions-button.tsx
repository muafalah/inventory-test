...
export const ActionsButton = ({ id }: { id: string }) => {
  ...
  const { mutate: mutateDelete, isPending: isDeleting } = useMutation({
    mutationKey: [inventoryService.keys.deleteById],
    mutationFn: () =>
      apiClient.delete(inventoryService.endpoints.deleteById(id)),
    onSuccess: ({ data }) => {
    ...
    <>
      ...
      {showDialog && (
        <ConfirmDialog
          ...
          description="This action cannot be undone. This will permanently delete your inventory and remove your data from our servers."
